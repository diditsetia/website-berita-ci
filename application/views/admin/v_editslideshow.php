                  ...
                  <ul class="nav nav-tabs">
                      <li class="active">
                        <a data-toggle="tab" href="#demo-lft-tab-2">
                            <i class="ti-pencil"></i>
                            <span class="menu-title">Edit Slideshow</span>
                        </a>
                      </li>
                        ...
                        <div class="">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="">
                                    <!--Horizontal Form-->
                                    <!--===================================================-->
                                   <form class="form-horizontal" enctype='multipart/form-data' method="post" action="<?php echo site_url('admin/updateslideshow')?>">
                                     <div class="form-group">
                                         <label class="col-md-2 control-label" for="demo-hor-inputemail"></label>
                                         <div class="col-sm-9">
                                           <input type="hidden" name="id" value="<?php echo $editslideshow->id_slideshow ?>">
                                           <div  class="image-upload" style="height: 200px; width: 100% ; ">
                                             <?php if ($editslideshow->picture == NULL) { ?>
                                             ...
                                             <?php } else { ?>
                                               <label  for="file-input" >
                                                 <img  class=""  src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$editslideshow->picture); ?>"
                                             ...
                                             <input type='hidden' name='oldfile' value="<?php echo $editslideshow->picture ?>"  id='file-input' >
                                              <?php } ?>
                                     ...
                                     <div class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                             <input type="text" class="form-control" name="judul" value="<?php echo $editslideshow->judul?>">
                                          </div>
                                     </div>
                                     ...
                                     <div class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                             <input type="text" class="form-control" name="keterangan" value="<?php echo $editslideshow->keterangan?>">
                                          </div>
                                     </div>
