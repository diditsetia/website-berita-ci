                                ...
                                <div class="col-md-12">
                                     ...
                                     <div class="form-group">
                                       <div class="col-sm-12">
                                         ...
                                         <textarea class="form-control mceEditoreditvisi" name="visi" > <?php echo $editvisimisi->visi ;?></textarea>
                                       </div>
                                     </div>
                                     ...
                                     <div class="form-group">
                                       <div class="col-sm-12">
                                         <label  class="control-label">Visi</label>
                                         <textarea class="form-control mceEditoreditvisi" name="misi" > <?php echo $editvisimisi->misi;?></textarea>
                                       </div>
                                     </div>
