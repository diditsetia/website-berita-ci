        ...
        <div id="mainnav-menu-wrap">
                        ...
                        <div class="profile-wrap text-center">
                            <div class="pad-btm">
                              <?php if ($dataadmin['foto'] == '') { ?>
                                  <img class="img-circle img-md" src="<?php echo base_url('assets/admin/img/profile-photos/4.png') ?>" alt="Profile Picture">
                              <?php }else { ?>
                                  <img class="img-circle img-md" style="object-fit: cover;" src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$dataadmin['foto']); ?>" alt="Profile Picture">
                              <?php } ?>
                            ...
                            <a href="#profile-nav" class="box-block" data-toggle="collapse" aria-expanded="false">
                                ...
                                <p class="mnp-name"><?php echo $dataadmin['nama'] ?></p>
                                <span class="mnp-desc"><?php echo $dataadmin['email'] ?></span>
                            </a>
                        </div>
                        <div id="profile-nav" class="collapse list-group bg-trans">

                            <a href="<?php echo site_url ('admin/logout') ?>" class="list-group-item">
            ...
            <li >
                ...
                <ul class="collapse out">
                  ...
                  <li><a  href="<?php echo site_url('admin/menu')?>">Tambah Menu</a></li>
                  <li><a  href="<?php echo site_url('admin/slideshow')?>">Slideshow</a></li>
                  <li><a href="<?php echo site_url('admin/footer')?>">Configurasi Tambahan</a></li>
          ...
          <?php } elseif ($this->uri->segment(2) == 'header' || $this->uri->segment(2) == 'menu' || $this->uri->segment(2) == 'slideshow' || $this->uri->segment(2) == 'footer' || $this->uri->segment(2) == 'pengaturanadmin') { ?>
              <li class="">
                  <a href="<?php echo site_url('admin') ?>">
                      <i class="ti-dashboard"></i>
                      <span class="menu-title">Dashboard</span>
              ...
              <li class="active-link" >
                  ...
                  <ul class="collapse in">
                    <?php if ($this->uri->segment(2) == 'header') { ?>
                      ...
                      <li><a  href="<?php echo site_url('admin/footer')?>">Configurasi Tambahan</a></li>
                      <li><a  href="<?php echo site_url('admin/pengaturanadmin') ?>">Admin</a></li>
                    <?php }elseif ($this->uri->segment(2) == 'menu') { ?>
                      <li><a href="<?php echo site_url('admin/header') ?>">Header</a></li>
                      <li class="active-link"> <a  href="<?php echo site_url('admin/menu')?>">Tambah Menu</a></li>
                      <li><a href="<?php echo site_url('admin/slideshow')?>">Slideshow</a></li>
                      <li><a href="<?php echo site_url('admin/footer') ?>">Configurasi Tambahan</a></li>
                      <li><a  href="<?php echo site_url('admin/pengaturanadmin') ?>">Admin</a></li>
                    <?php }elseif ($this->uri->segment(2) == 'slideshow') { ?>
                      <li><a href="<?php echo site_url('admin/header') ?>">Header</a></li>
                      <li><a href="<?php echo site_url('admin/menu')?>">Tambah Menu</a></li>
                      <li class="active-link"><a href="<?php echo site_url('admin/slideshow')?>">Slideshow</a></li>
                      <li><a  href="<?php echo site_url('admin/footer')?>">Configurasi Tambahan</a></li>
                      <li><a href="<?php echo site_url('admin/pengaturanadmin')?>">Admin</a></li>
                    <?php }elseif ($this->uri->segment(2) == 'footer') {?>
                      <li><a href="<?php echo site_url('admin/header') ?>">Header</a></li>
                      <li><a href="<?php echo site_url('admin/menu')?>">Tambah Menu</a></li>
                      <li ><a href="<?php echo site_url('admin/slideshow')?>">Slideshow</a></li>
                      <li class="active-link"><a  href="<?php echo site_url('admin/footer')?>">Configurasi Tambahan</a></li>
                      <li><a href="<?php echo site_url('admin/pengaturanadmin') ?>">Admin</a></li>
                    <?php } else { ?>
                      <li><a href="<?php echo site_url('admin/header') ?>">Header</a></li>
                      <li><a href="<?php echo site_url('admin/menu')?>">Tambah Menu</a></li>
                      <li ><a href="<?php echo site_url('admin/slideshow')?>">Slideshow</a></li>
                      <li ><a  href="<?php echo site_url('admin/footer')?>">Configurasi Tambahan</a></li>
                      <li class="active-link"><a href="<?php echo site_url('admin/pengaturanadmin') ?>">Admin</a></li>
                    <?php } ?>
                  </ul>
              </li>
            <?php }  else { ?>
