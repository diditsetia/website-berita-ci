                            ...
                            <div class="col-lg-12">
                                <div class="">
                                    ...
                                    <div style="padding-bottom: 0px;" class="panel-body">
                                      ...
                                      <?php if ($datalayanan == null) { ?>
                                        <div class="alert alert-danger" role="alert">
                                           <p><?php echo 'Layanan Belum Ada' ?></p>
                                        </div>
                                      <?php }else { ?>
                                        <div class="col-md-12">
                                        ...
                                        <div id="demo-tasklist-3" class="task-success ui-sortable-handle">
                                           <div class="task-img">
                                               <img  class="img-thumbnail" src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$datalayanan['picture']); ?>" alt="Image"
                                                style="height: 100%; width: auto;margin-bottom: 10px; "
                                               >
                                           </div>
                                           <p class="pad-btm ">LAYANAN:<?php echo $datalayanan['layanan']?></p>
                                           <hr>
                                              <?php if ($datalayanan == null) { ?>
                                                ...
                                                <span class="box-inline">
                                                  ...
                                                  <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                      ...
                                                      <div class="col-sm-3">
                                                      <a href="<?php echo  site_url('admin/hapuslayanan').'/'.$datalayanan['id_layanan'];?>"><button type="submit" name="submit" class="btn btn-info" style="width:100%">Hapus</button></a>
                                                    </div>
                                                      </div>
                                                    </div>
                                                  </div>
                                ...
                                <div class="col-sm-12">
                                     ...
                                     <div class="form-group">
                                       <div class="col-sm-12">
                                         ...
                                         <textarea class="form-control mceEditorlayanan" name="layanan" >
                                           <?php echo ($data == "" ? "" : $data['layanan'])?>
                                         </textarea>
                                       </div>
                                     </div>
