<div class="content container">
    <div class="page-wrapper">
        <header class="page-heading clearfix">
            ...
            <h1 class="heading-title pull-left">Sejarah</h1>
        ...
        <div class="page-content">
            <div class="row page-row">
                <article class="welcome col-md-9 col-sm-8">
                    <p><img class="img-responsive" src="<?php echo base_url('assets/admin/img/penyimpananfoto'.'/'.$datasejarah['foto_sejarah']); ?>" alt="" /></p>
                    <p><?php echo $datasejarah['sejarah'] ?></p>
