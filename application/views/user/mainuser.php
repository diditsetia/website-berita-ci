...
<!-- Mirrored from themes.3rdwavemedia.com/college-green/1.6.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Nov 2017 06:37:43 GMT -->
<head>
  <?php
    $query = $this->db->get('tabel_header');
    $dataheader = $query->row_array();
  ?>
    <title><?php echo $dataheader['tagline'] ?></title>
    <!-- Meta -->
    ...
    <link href="<?php echo base_url('assets/fonts.googleapis.com/cssff98.css?family=Open+Sans:300,400,600,700') ?>" rel='stylesheet' type='text/css'>
    <!-- Global CSS -->
    ...
    <!-- Theme CSS -->
    <link id="theme-style" rel="stylesheet" href="<?php echo base_url('assets/styles.css') ?>">
...
<body class="home-page">
    <div class="wrapper">
        ...
        <!-- Javascript -->
    <script type="text/javascript" src="<?php echo base_url('assets/plugins/jquery-1.12.3.min.js') ?>"></script>
...
<!-- Mirrored from themes.3rdwavemedia.com/college-green/1.6.1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Nov 2017 06:38:30 GMT -->
</html>
